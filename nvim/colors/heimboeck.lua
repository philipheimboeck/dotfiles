-- originally based on https://github.com/danrot/dotfiles/blob/master/nvim/colors/danrot.lua
vim.g.colors_name = 'heimboeck'
...
hl(0, 'Normal', { fg = colors.white, bg = colors.shark })
hl(0, 'CursorLine', { bg = colors.tuna })
...
hl(0, 'GitSignsAdd', { fg = colors.aquaForest })
hl(0, 'GitSignsChange', { fg = colors.whiskey })
hl(0, 'GitSignsDelete', { fg = colors.carnation })
...
hl(0, '@comment.todo', { fg = colors.whiskey })
